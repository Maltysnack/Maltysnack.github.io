...
- Folder reorg 18-05-2026: `games/magic.{html,js,css}` + `games/data/` + `games/synergy-score.html` collapsed into `games/magic/`. `projects/duoclue/` moved to `games/duoclue/`. Redirect stubs left at old paths.
