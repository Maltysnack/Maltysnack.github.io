...
(function () {
  ...
  function active(href) {
    // Match if the path ends with the href filename
    const file = href.split('/').pop();
    return (path.endsWith(href) || path.endsWith('/' + file))
      ? 'style="color: var(--text); font-weight: 400;"'
      : '';
  }
  ...
  const html = `
    <div class="sidebar-top">
      <a href="/index.html" class="logo-link">
        <img src="https://github.com/maltysnack.png" alt="maltysnack avatar" class="avatar" />
        <span class="site-name">maltysnack</span>
      </a>
      <p class="site-tagline">films · games · words</p>
    </div>
    ...
    <nav class="nav">
      ...
      <div class="nav-section">
        ...
        <ul>
          <li><a href="/README/index.html" ${active('/README/index.html')}>Thoughts</a></li>
          <li><a href="/games/index.html" ${active('/games/index.html')}>Games</a></li>
        </ul>
      </div>

      <div class="nav-section nav-section--single">
        <a href="/red-rebels.html" class="nav-label nav-label--link nav-label--rebels" ${active('/red-rebels.html')}>Red Rebels</a>
      </div>

      <div class="nav-section nav-section--single">
        <a href="/proveyourself.html" class="nav-label nav-label--link" ${active('/proveyourself.html')}>proveyourself</a>
      </div>

      <div class="nav-section nav-section--single">
        <a href="/shop.html" class="nav-label nav-label--link" ${active('/shop.html')}>Shop</a>
      </div>
  ...
  // Inject into <aside class="sidebar"> or <aside id="sidebar">
