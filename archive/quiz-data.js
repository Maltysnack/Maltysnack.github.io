      ...
      questions: [
        {
          ...
          explanation: "Labour's 2024 win was historic in scale of seats won, though their vote share was relatively modest thanks to vote splitting among right-wing parties."
        },
        {
          ...
          explanation: "The European Parliament elections in June 2024 saw far-right parties gain across the continent, prompting Macron's high-stakes gamble of a snap election."
        },
        {
          ...
          explanation: "Sweden ended over 200 years of military non-alignment when it became the 32nd NATO member, joining Finland which had joined in April 2023."
        },
        {
          ...
          explanation: "Claudia Sheinbaum was inaugurated in October 2024, becoming Mexico's first female president after a career as a climate scientist and Mexico City mayor."
        }
      ]
    },
    {
      ...
      questions: [
        {
          ...
          explanation: "Paris 2024 was the third time the city hosted the Olympics, and the first time an opening ceremony was held outside a stadium, with athletes parading along the Seine."
        },
        {
          ...
          explanation: "Alcaraz's win over Djokovic in 2024 was in straight sets (6-2, 6-2, 7-6), an unusually dominant performance in a Wimbledon final."
        },
        {
          ...
          explanation: "Team USA won 126 medals total at Paris 2024, with Simone Biles and Noah Lyles among the headline performers for the American team."
        },
        {
          ...
          explanation: "India's 2024 T20 World Cup win came 17 years after their first, with Virat Kohli named Player of the Tournament despite retiring from T20 internationals after the final."
        }
      ]
    },
    {
      ...
      questions: [
        {
          ...
          explanation: "Oppenheimer's seven Oscar wins at the 96th Academy Awards included Best Picture, Best Director (Christopher Nolan's first), and Best Actor for Cillian Murphy."
        },
        {
          ...
          explanation: "The Eras Tour broke the $1 billion barrier to become the first tour in history to do so, and the final gross was reported at around $2.08 billion."
        },
        {
          ...
          explanation: "Helldivers 2's explosive launch in February 2024 was so successful it overwhelmed the game's servers, and its co-op gameplay made it a social media hit."
        },
        {
          ...
          explanation: "Taylor Swift's fourth Album of the Year Grammy broke the previous record she shared with Frank Sinatra, Paul Simon, and Stevie Wonder."
        }
      ]
    },
    {
      ...
      questions: [
        {
          ...
          explanation: "Starship's full reusability — booster and upper stage both returning to land — is central to SpaceX's goal of dramatically reducing the cost of reaching orbit."
        },
        {
          ...
          explanation: "Anthropic was founded in 2021 by Dario Amodei, Daniela Amodei, and other former OpenAI staff, and develops Claude using a safety-focused 'Constitutional AI' approach."
        },
        {
          ...
          explanation: "The James Webb Space Telescope operates in the infrared spectrum, allowing it to see through dust and observe the earliest galaxies formed after the Big Bang."
        },
        {
          ...
          explanation: "The 1.5°C threshold was set in the 2015 Paris Agreement as a target to limit warming; 2024 was the first calendar year to exceed it, though scientists noted it reflects a single year rather than a permanent trend."
        }
      ]
    },
    {
      ...
      questions: [
        {
          ...
          explanation: "The Strait of Malacca is only 2.8 km wide at its narrowest point, making it a critical and potentially vulnerable chokepoint for global trade."
        },
        {
          ...
          explanation: "Tungsten (W for Wolfram) has the highest melting point of any pure element at 3,422°C, which is why it is used in light bulb filaments and high-temperature applications."
        },
        {
          ...
          explanation: "Kikunae Ikeda discovered umami in 1908 while studying kombu seaweed broth; the flavour is now understood to be detected by specific taste receptors responding to glutamate."
        },
        {
          ...
          explanation: "The Trans-Siberian Railway, completed in 1916, spans 9,289 km and crosses 8 time zones — the longest single continuous railway line in the world."
        }
      ]
    }
  ]
